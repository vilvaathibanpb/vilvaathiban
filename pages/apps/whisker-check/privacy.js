...
const PrivacyPage = () => (
  <Container>
    <Head>
      ...
      <meta
        name="description"
        content="Privacy policy for Whisker Check on iPhone. Your cats, checks, notes and photos stay on your device. No account and no analytics; the free version shows Google AdMob banners."
      />
    ...
    <Wrap>
      ...
      <Section>
        <h2>5. Children</h2>
        <p>
          The App is meant to be used by adults. It is not directed at children. We collect no information from anyone, and ads
