...
const URL = "https://www.vilvaathiban.com/apps/voice-note-to-text/privacy";

const PrivacyPage = () => (
  <Container>
    <Head>
      <title>Privacy Policy — Voice Note to Text</title>
      <meta
        name="description"
        content="Privacy policy for the Voice Note to Text iOS app. Everything is processed on your device; the app has no accounts, no servers, no analytics and no ads."
      />
    ...
    <Wrap>
      ...
      <Section>
        <p>
          This Privacy Policy describes how the iOS application <b>Voice Note to Text</b>
          (&quot;the App&quot;), developed by Vilva Athiban P B (&quot;we&quot;,
          &quot;us&quot;), handles your information. The App transcribes voice notes and audio files to text using a speech-recognition model that runs entirely on your device.
      ...
      <Section>
        ...
        <p>
          <b>Audio files you pick or share to the App</b> — decoded and transcribed on your device by a bundled Whisper speech model. Audio is never uploaded. A temporary 16 kHz copy is kept in the App&apos;s cache during transcription and overwritten by the next file.
          <br />
          <b>Transcripts</b> — shown on screen and kept only in memory. They leave the App only when you tap Copy or Share.
        </p>
      ...
      <Section>
        ...
        <p>The App makes no network requests. The speech model ships inside the App, so nothing is downloaded and transcription works fully offline, including in airplane mode.</p>
      </Section>

      <Section>
        <h2>3. Permissions the App requests</h2>
        <p>None. Files reach the App only through the iOS document picker or the share sheet ("Copy to Voice to Text"). The App does not use the microphone. Every permission can be declined or revoked in iOS Settings.</p>
      </Section>
      ...
      <Section>
        <h2>7. Trademarks</h2>
        <p>
          Voice Note to Text is an independent utility. It is not affiliated with,
      ...
      <Section>
        ...
        <p>
          ...
          <Link href="/apps/voice-note-to-text/support">support page</Link> or email{" "}
